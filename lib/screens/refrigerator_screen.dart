...
class _RefrigeratorScreen extends State<RefrigeratorScreen> {
                          ...
                          FittedBox(
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 20),
                                DragTarget<FridgeProduct>(
                                    onAccept: (FridgeProduct fridgeProduct) {
  ...
  Widget showEditDialog(FridgeProduct fridgeProduct) {
    List currentGoodies = checkCurrentProductList(fridgeProduct);
  ...
  List checkCurrentProductList(FridgeProduct frProduct) {

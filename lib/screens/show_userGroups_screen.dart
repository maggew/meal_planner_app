...
class _ShowUserGroupsScreen extends State<ShowUserGroupsScreen> {
                    ...
                    for (int i = 0; i < numberGroups; i++) {
                      ...
                      groups.add(new Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            buildGroupAvatar(groupName, transferGroupPic, groupID, groupMembers),
                            Column(
                              children: [
                                SelectableText(
                                  groupID,
  ...
  Widget buildGroupAvatar(String grName, String image, String grID, List grMembers) {
    ...
    if (group_id == grID) {
      return GestureDetector(
        onTap: (){
          Navigator.pushNamed(context, '/show_singleGroup', arguments: GroupInfo(grName, grID, image, grMembers));
        },
        child: Container(
          width: 150,
